...
proc route*(container: var Container, path: Uri | string, httpMethod: HttpMethod, handler: RequestHandler): void =
...
proc get*(container: var Container, path: Uri | string, handler: RequestHandler): void =
...
proc post*(container: var Container, path: Uri | string, handler: RequestHandler): void =
...
proc put*(container: var Container, path: Uri | string, handler: RequestHandler): void =
...
proc delete*(container: var Container, path: Uri | string, handler: RequestHandler): void =
...
proc trace*(container: var Container, path: Uri | string, handler: RequestHandler): void =
...
proc options*(container: var Container, path: Uri | string, handler: RequestHandler): void =
...
proc connect*(container: var Container, path: Uri | string, handler: RequestHandler): void =
...
proc patch*(container: var Container, path: Uri | string, handler: RequestHandler): void =
